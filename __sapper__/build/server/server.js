...
const css = {
	code: "h1.svelte-35cw6v,figure.svelte-35cw6v,p.svelte-35cw6v{text-align:center;margin:0 auto}h1.svelte-35cw6v{font-size:2.8em;font-weight:400;margin:0 0 0.5em 0}figure.svelte-35cw6v{margin:0 0 1em 0}img.svelte-35cw6v{width:100%;max-width:400px;margin:0 0 1em 0}p.svelte-35cw6v{margin:1em auto;padding-bottom:1em}@media(min-width: 480px){h1.svelte-35cw6v{font-size:4em}}",
	map: "{\"version\":3,\"file\":\"index.svelte\",\"sources\":[\"index.svelte\"],\"sourcesContent\":[\"<style>\\n\\th1, figure, p {\\n\\t\\ttext-align: center;\\n\\t\\tmargin: 0 auto;\\n\\t}\\n\\n\\th1 {\\n\\t\\tfont-size: 2.8em;\\n\\t\\tfont-weight: 400;\\n\\t\\tmargin: 0 0 0.5em 0;\\n\\t}\\n\\n\\tfigure {\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\timg {\\n\\t\\twidth: 100%;\\n\\t\\tmax-width: 400px;\\n\\t\\tmargin: 0 0 1em 0;\\n\\t}\\n\\n\\tp {\\n\\t\\tmargin: 1em auto;\\n\\t\\tpadding-bottom: 1em;\\n\\t}\\n\\n\\t@media (min-width: 480px) {\\n\\t\\th1 {\\n\\t\\t\\tfont-size: 4em;\\n\\t\\t}\\n\\t}\\n</style>\\n<script>\\nimport \\\"tailwindcss/tailwind.css\\\"\\n</script>\\n<svelte:head>\\n\\t<title>a minimal sapper blog</title>\\n</svelte:head>\\n<p>welcome to</p>\\n<h1>the<b>blog.</b></h1>\\n\\n<figure>\\n\\t<img alt='the birds on a line' src='bird-bg.png'>\\n\\t<figcaption>where less is more</figcaption>\\n</figure>\\n\\n<p><strong>we're minimal and that might seem boring, except you're actually paying attention.</strong></p>\\n<p class=\\\"link\\\"><a href=\\\"about\\\">find out why</a>...</p>\"],\"names\":[],\"mappings\":\"AACC,gBAAE,CAAE,oBAAM,CAAE,CAAC,cAAC,CAAC,AACd,UAAU,CAAE,MAAM,CAClB,MAAM,CAAE,CAAC,CAAC,IAAI,AACf,CAAC,AAED,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,KAAK,CAChB,WAAW,CAAE,GAAG,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,KAAK,CAAC,CAAC,AACpB,CAAC,AAED,MAAM,cAAC,CAAC,AACP,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,AAClB,CAAC,AAED,GAAG,cAAC,CAAC,AACJ,KAAK,CAAE,IAAI,CACX,SAAS,CAAE,KAAK,CAChB,MAAM,CAAE,CAAC,CAAC,CAAC,CAAC,GAAG,CAAC,CAAC,AAClB,CAAC,AAED,CAAC,cAAC,CAAC,AACF,MAAM,CAAE,GAAG,CAAC,IAAI,CAChB,cAAc,CAAE,GAAG,AACpB,CAAC,AAED,MAAM,AAAC,YAAY,KAAK,CAAC,AAAC,CAAC,AAC1B,EAAE,cAAC,CAAC,AACH,SAAS,CAAE,GAAG,AACf,CAAC,AACF,CAAC\"}"
};

const Routes = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css);

	return `${($$result.head += `${($$result.title = `<title>a minimal sapper blog</title>`, "")}`, "")}
<p class="${"svelte-35cw6v"}">welcome to</p>
<h1 class="${"svelte-35cw6v"}">the<b>blog.</b></h1>

<figure class="${"svelte-35cw6v"}"><img alt="${"the birds on a line"}" src="${"bird-bg.png"}" class="${"svelte-35cw6v"}">
	<figcaption>where less is more</figcaption></figure>

<p class="${"svelte-35cw6v"}"><strong>we&#39;re minimal and that might seem boring, except you&#39;re actually paying attention.</strong></p>
<p class="${"link svelte-35cw6v"}"><a href="${"about"}">find out why</a>...</p>`;
});
...
const Nav = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<nav class="${"svelte-1e04o6n"}"><ul class="${"svelte-1e04o6n"}"><li class="${"svelte-1e04o6n"}"><a href="${"/"}" class="${"svelte-1e04o6n"}">the<b class="${"svelte-1e04o6n"}">blog.</b></a></li>
