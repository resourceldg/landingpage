...
const Whatsapp = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	return `<div class="${"grid md:grid-cols-3 bg-green-200 gap-4 rounded-bl place-items-center m-4 rounded-3xl"}"><div class="${"p-4 col-span-2"}"><h3 class="${"text-sm text-gray-700"}"><span class="${"font-bold text-2xl  "}">Qué estás esperando?</span>
            <br>Ya podés tener tu catálogo de serivicos o productos listo para 
            pegar por toda tu tienda y además compartirla por cualquier medio digital. 
            <span class="${"font-bold"}">Vendé como un profesional</span> <br>
            Si tenés dudas hacé click en el logo y escibinos...
...
const Hero = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	...
	: `*Oferta válida por 48 hs.`}</p></div></div>`;
});
...
const Features = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"shadow-lg grid grid-cols-1 place-items-center "}"><div class="${"grid place-items-center m-8 p-4 "}"><h2 class="${"text-blue-600 font-bold font-size-lg text-2xl mb-4"}"><span class="${"text-green-500"}">NO PIERDAS MAS VENTAS...</span>
            <br>
