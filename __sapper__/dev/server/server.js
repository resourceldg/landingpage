...
const css$5 = {
	code: ".wsp.svelte-vnq8fq{transition:0.3s ease-out}.wsp.svelte-vnq8fq:hover{transform:rotate(360deg)}",
	map: "{\"version\":3,\"file\":\"Whatsapp.svelte\",\"sources\":[\"Whatsapp.svelte\"],\"sourcesContent\":[\"\\n<style>\\n    .wsp {\\n        transition: 0.3s ease-out;\\n    }\\n    .wsp:hover {\\n        transform: rotate(360deg);\\n    }\\n</style>\\n\\n<div\\n    class=\\\"grid md:grid-cols-3 bg-green-200 gap-4 rounded-bl place-items-center m-4 rounded-3xl\\\">\\n    <div class=\\\"p-4 col-span-2\\\">\\n        <h3 class=\\\"text-sm text-gray-700\\\">\\n            <span class=\\\"font-bold text-2xl  \\\">No pierdas ventas!!!</span>\\n            <br />Ya podés tener tu menú digital o tu catálogo de productos para \\n            pegar por toda tu tienda mientras estas atendiendo y además compartirla por cualquier medio digital. \\n            <span class=\\\"font-bold\\\">Vendé </span>\\n            <span class=\\\"font-bold \\\">COMO UN PROFESIONAL </span> si tenés dudas hacé click en el\\n            logo y escibirnos...\\n        </h3>\\n    </div>\\n    <div class=\\\"grid col-start-3  mr-2\\\">\\n        <img class=\\\"wsp object-fill\\\" src=\\\"wsp2.png\\\" alt=\\\"logo whatsapp\\\" />\\n    </div>\\n</div>\\n\"],\"names\":[],\"mappings\":\"AAEI,IAAI,cAAC,CAAC,AACF,UAAU,CAAE,IAAI,CAAC,QAAQ,AAC7B,CAAC,AACD,kBAAI,MAAM,AAAC,CAAC,AACR,SAAS,CAAE,OAAO,MAAM,CAAC,AAC7B,CAAC\"}"
};

const Whatsapp$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	$$result.css.add(css$5);

	return `<div class="${"grid md:grid-cols-3 bg-green-200 gap-4 rounded-bl place-items-center m-4 rounded-3xl"}"><div class="${"p-4 col-span-2"}"><h3 class="${"text-sm text-gray-700"}"><span class="${"font-bold text-2xl  "}">No pierdas ventas!!!</span>
            <br>Ya podés tener tu menú digital o tu catálogo de productos para 
            pegar por toda tu tienda mientras estas atendiendo y además compartirla por cualquier medio digital. 
            <span class="${"font-bold"}">Vendé </span>
            <span class="${"font-bold "}">COMO UN PROFESIONAL </span> si tenés dudas hacé click en el
...
const Feature$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"grid grid-cols-1 md:grid-cols-4 place-items-center rounded-bl "}"><div class="${"text-indigo-600 font-bold col-span-3 self-center "}">${$$slots.featureContent ? $$slots.featureContent({}) : ``}</div>

    <div class="${"mb-8 self-center"}">${$$slots.featureIcon
	? $$slots.featureIcon({})
	: `aquí va un ícono`}</div></div>`;
});
...
const Features$1 = create_ssr_component(($$result, $$props, $$bindings, $$slots) => {
	return `<div class="${"shadow-lg "}"><div class="${"grid place-items-center m-8 p-4 "}"><h2 class="${"text-blue-600 font-bold font-size-lg text-2xl mb-4"}"><span class="${"text-green-500"}">ESTE VERANO NOS CUIDAMOS ENTRE TODOS...</span>
            <br>
            Por menos de lo que cuesta una zapatilla obtenés...
        </h2></div>
    <div class="${"grid self-center"}">${validate_component(Feature$1, "Feature").$$render($$result, {}, {}, {
		featureIcon: () => `<span slot="${"featureIcon"}"><img src="${"qrscan.png"}" alt="${"caja"}" width="${"200"}" height="${"auto"}"></span>`,
		featureContent: () => `<span slot="${"featureContent"}">Hasta 100 productos o servicios</span>`,
		default: () => `
            `
	})}</div></div>`;
});
